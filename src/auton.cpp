...
void skillsAuto(){
  ...
  chassis.moveToPoint(127, 10, 1000, {.forwards = false, .maxSpeed = 80});
  intake.move_voltage(0);
  unclampGoal();
  ...
  chassis.moveToPose(48, 24, 90, 4000, {.forwards = false, .maxSpeed = 50});
  clampGoal();
  intake.move_voltage(12000);

  chassis.moveToPoint(48, 48, 4000);
  chassis.moveToPoint(18, 67, 4000, {.maxSpeed = 60});
  ...
  chassis.turnToHeading(-135, 1000, {.maxSpeed = TURN_SPEED});
  chassis.moveToPoint(48, 92, 4000, {.maxSpeed = 80});
  chassis.moveToPoint(25, 90, 4000, {.maxSpeed = 80});
  ...
  intake.move_voltage(0);
  unclampGoal();
  chassis.moveToPoint(4, 140, 1000, {.forwards = false, .maxSpeed = 120});

  chassis.moveToPoint(48, 120, 4000);
